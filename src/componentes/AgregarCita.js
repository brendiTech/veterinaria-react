...
class AgregarCita extends Component {
    ...
    nombreMascotasRef = React.createRef();
    ...
    crearNuevaCita = e =>{
        ...
        const mascota = this.nombreMascotasRef.current.value,
                    ...
                    <form onSubmit={this.crearNuevaCita}>
                        <div className="form-group row">
                            ...
                            <div className="col-sm-8 col-lg-10">
                                <input ref={this.nombreMascotasRef} type="text" className="form-control" placeholder="Nombre Mascota" />
                            </div>
                        </div>
                        <div className="form-group row">
